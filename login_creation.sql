...
--Below sp will give create login statements of all logins, output of this script will have create login statement
EXEC sp_help_revlogin

--Check on destination server what all logins are there
